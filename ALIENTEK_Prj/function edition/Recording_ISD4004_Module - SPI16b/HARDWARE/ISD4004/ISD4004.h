...
//指令表
//快进只能在放音操作开始时选择。
#define ISD4004_PwrUpEnable 0x2000  //上电:等待TPUD 后器件可以工作
#define ISD4004_SetPlayAddr 0xE000 //从指定地址开始放音。后跟PLAY 指令可使放音继续进行下去
#define ISD4004_PlayAtCrtAddr 0xF000 //从当前地址开始放音(直至EOM 或OVF)
#define ISD4004_SetRecAddr 0xA000 //从指定地址开始录音。后跟REC 指令可使录音继续进行下去
#define ISD4004_RecAtCrtAddr 0xB000  //从当前地址开始录音(直至OVF 或停止)
#define ISD4004_SetMc 0xE800 //从指定地址开始快进。后跟MC 指令可使快进继续进行下去
#define ISD4004_Mc 0xF8 //执行快进,直到EOM.若再无信息,则进入OVF 状态
#define ISD4004_StopCrtWr 0x3000 //停止当前操作
#define ISD4004_StopWrPwrDn 0x1000 //停止当前操作并掉电
...
void ISD4004_Rec(u16 addr); //开始录音
void ISD4004_PlayRec(u16 addr);//播放录音

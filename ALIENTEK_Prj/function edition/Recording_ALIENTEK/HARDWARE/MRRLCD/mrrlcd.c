...
void draw_dir_receive(u16 y,u8 checkkey)
{
	...
	Show_Str(450-16*5-80-16*5,y,240,16,"当前选择->",16,0);				//显示歌曲名字 
	//Show_Str(450-16*5-80-16*5,y+40,240,16,"下一首：",16,0);				//显示歌曲名字 
	Show_Str(450-16*5-80-16*5,y+80,240,16,"点击右下角头像返回上一级/停止",16,0);
	//LCD_Fill(450-16*5-80-16*5,y+60,480,y+60+16,WHITE);				//清除之前的显示
...
//			FILINFO mp3fileinfo;//文件信息
		...
		Recording_Dialog();//显示音乐播放器 录制语音 激光传输
		LED0=0;LED1=0;
//		delay_ms(1000);
//		LED0=1;LED1=0;
		POINT_COLOR=BROWN;	
		Show_Str(450-16*5-80-16*5,540+60,240,16,"当前在菜单目录，请触屏选择功能。",16,0);
		POINT_COLOR=RED;//设置字体为红色5
		tp_dev.scan(0);
		if((tp_dev.sta)&(1<<0))
	{
			//音乐播放器
			if(tp_dev.x[0]>30&&tp_dev.y[0]>270&&tp_dev.x[0]<(30+180)&&tp_dev.y[0]<(270+84))
		{
			...
			Show_Str(450-16*5-80-16*5,540+60,240,16,"请选择功能，长按头像返回菜单！",16,0);
						...
						while(1)
						{
							...
							delay_ms(500);
								...
								if(TPAD_Scan(0))
								{
									...
									delay_ms(1000);
									//LCD_Fill(200,500,480,540+60+16,WHITE);				//清除右侧目录文本显示
									LCD_Fill(450-16*5-80-16*5,540+60,480,540+60+16,WHITE);				//清除之前的显示
							...
							delay_ms(500);
								...
								if(tp_dev.x[0]>(50-20) &&tp_dev.y[0]> (520-20)  &&tp_dev.x[0]<(50+7*16+20)  &&tp_dev.y[0]< (520+16+20) ) //查看录音目录触摸屏按键
								{
									...
									if(tp_dev.x[0]>(50-20) &&tp_dev.y[0]> (520-20)  &&tp_dev.x[0]<(50+7*16+20)  &&tp_dev.y[0]< (520+16+20) ) //查看录音目录触摸屏按键
									{
										...
										//添加清空目录函数
										LCD_Fill(200,480,480,540+60+16,WHITE);	
										break;
...
//			draw_button(720,16*5,"查看下一下",16);
			...
			draw_button_dir(50,520,16*7,"接收模式",16);
					...
					{	
							...
							{									
								LCD_Fill(450-16*5-80-16*5,540+60,480,540+60+16,WHITE);				//清除之前的显示
								LCD_Fill(450-16*5-80-16*5,540+80,480,540+80+16,WHITE);				//清除之前的显示
								...
								while(1)
								{
									...
									if(tp_dev.x[0]>(50-20)&&tp_dev.y[0]>(400-20)&&tp_dev.x[0]<(50+7*16+20)&&tp_dev.y[0]<(400+16+20))
									{
										...
										if(tp_dev.x[0]>(50-20)&&tp_dev.y[0]>(400-20)&&tp_dev.x[0]<(50+7*16+20)&&tp_dev.y[0]<(400+16+20))
										{
											...
											LCD_Fill(450-16*5-80-16*5,540+80,480,540+80+16,WHITE);	
											Show_Str(450-16*5-80-16*5,540+80,240,16,"长按右下头像，返回上一级",16,0);
									...
									if((tp_dev.sta)&(1<<0)) //检查“发送选择/重新选择”触摸屏按键是否被按下
										{
											...
											{ 	
												...
												{	
													while(rect==1){
														...
														LCD_Fill(200,500,480,540+60+16,WHITE);				//清除右侧目录文本显示
														Show_Str(450-16*5-80-16*5,540+40,240,16,"程序待添加........",16,0);
														
														//此处添加波形发送函数
														if(TPAD_Scan(0)) //退出 查看接收文件夹 回到功能选择
														{
															//LCD_Fill(0,560,480,800,WHITE); //清空 播放当前 按钮文本
															//LCD_Fill(200,480,480,800,WHITE);
															LCD_Fill(200,500,480,540+60+16,WHITE);				//清除右侧目录文本显示
															LCD_Fill(450-200,540+60,480,540+60+16,WHITE);				//清除之前的显示
													...
													while(teeth==1){
																...
																if(TPAD_Scan(0)) //退出 查看接收文件夹 回到功能选择
																{
																	...
																	LCD_Fill(200,500,480,540+60+16,WHITE);				//清除右侧目录文本显示
																	LCD_Fill(450-200,540+60,480,540+60+16,WHITE);				//清除之前的显示
																	LCD_Fill(450-200,540+80,480,540+80+16,WHITE);				//清除之前的显示
																	Show_Str(450-16*5-80-16*5,540+60,240,16,"返回成功",16,0);
																	delay_ms(1000);
																	LCD_Fill(450-16*5-80-16*5,540+60,480,540+60+16,WHITE);				//清除之前的显示
												...
												if(tp_dev.x[0]>(450-16*5-100)&&tp_dev.y[0]>(720-10)&&tp_dev.x[0]<(450-100+20)&&tp_dev.y[0]<(720+16+10))
											{
													...
													if(tp_dev.x[0]>(450-16*5-100)&&tp_dev.y[0]>(720-10)&&tp_dev.x[0]<(450-100+20)&&tp_dev.y[0]<(720+16+10))
												{
													rect=0,triagl=0,teeth=0;	
													LCD_Fill(450-16*5-80-16*5,540+60,480,540+85,WHITE);				//清除之前的显示
													Show_Str(450-16*5-80-16*5,540+60,240,16,"请重新选择类型。",16,0);
													LCD_Fill(450-16*5-80-16*5,540+80,480,540+80+16,WHITE);				//清除之前的显示
													Show_Str(450-16*5-80-16*5,540+80,240,16,"长按右下头像，返回上一级",16,0);
							...
							if(tp_dev.x[0]>(50-20) &&tp_dev.y[0]> (520-20)  &&tp_dev.x[0]<(50+7*16+20)  &&tp_dev.y[0]< (520+16+20) ) //查看录音目录触摸屏按键
							{
								...
								if(tp_dev.x[0]>(50-20) &&tp_dev.y[0]> (520-20)  &&tp_dev.x[0]<(50+7*16+20)  &&tp_dev.y[0]< (520+16+20) ) //查看录音目录触摸屏按键
								{
									...
									LCD_Fill(450-16*5-80-16*5,540+60,480,540+85,WHITE);				//清除之前的显示
									Show_Str(450-16*5-80-16*5,540+60,240,16,"进入接收模式成功，请选择功能。",16,0);
									Show_Str(450-16*5-80-16*5,540+80,240,16,"长按右下头像，返回上一级",16,0);
									LCD_Fill(50,390,260,550,WHITE);				//清除之前的显示
									draw_button_dir(50,400,16*7,"查看接收文件夹",16);
									draw_button_dir(50,460,16*7,"直接接收模式",16);
									draw_button_dir(50,520,16*8,"检测成功再接收",16);
									...
									while(1)
									{
										...
										if(tp_dev.x[0]>(50-20)&&tp_dev.y[0]>(400-20)&&tp_dev.x[0]<(50+7*16+20)&&tp_dev.y[0]<(400+16+20))
										{
											...
											if(tp_dev.x[0]>(50-20)&&tp_dev.y[0]>(400-20)&&tp_dev.x[0]<(50+7*16+20)&&tp_dev.y[0]<(400+16+20))
											{
												...
												LCD_Fill(200,480,480,800,WHITE);		//清除右侧目录文本								
												draw_button(650,16*5,"查看上一个",16);
												draw_button(720,16*5,"查看下一个",16);
												draw_button_dir(50,580,16*7,"播放当前选择",16);
											
														playindex2=0;
												firsttime=0;looknumb=0;
														while(1)
													{
										...
										if(tp_dev.x[0]>(50-20) &&tp_dev.y[0]> (460-20)  &&tp_dev.x[0]<(50+7*16+20)  &&tp_dev.y[0]< (460+16+20) ) //查看录音目录触摸屏按键
										{
											...
											if(tp_dev.x[0]>(50-20) &&tp_dev.y[0]> (460-20)  &&tp_dev.x[0]<(50+7*16+20)  &&tp_dev.y[0]< (460+16+20) ) //查看录音目录触摸屏按键
											{
												...
												while(1)
												{
														...
														LCD_Fill(450-16*5-16*5,540+60,480,540+60+16,WHITE);				//清除之前的显示
														Show_Str(450-16*5-80-16*5,540+60,240,16,"程序待添加...........",16,0);
														Show_Str(450-16*5-80-16*5,540+80,240,16,"点击右下角头像返回上一级/停止播放",16,0);
														//TPAD返回接收模式目录
														if(TPAD_Scan(0)) //退出 查看接收文件夹 回到功能选择
														{
										...
										//添加TPAD返回上一级																								
											if(TPAD_Scan(0)) //退出 接收模式目录 回到功能选择
										{
